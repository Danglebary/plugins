...
- No model-invocation removal beyond setup-agentic-flow.
...
- Lifecycle skills: next-prd→next-spec, to-prd→to-spec, to-tickets, next-ticket, done, retro, grill-me, improve-codebase-architecture, setup-agentic-flow (including the ticket_start config axis it provisions).
