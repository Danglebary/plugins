# pirr — whole-plugin deep-dive review
...
**Locations:** `next-ticket/SKILL.md:54,57`, `done/SKILL.md:25-26,76-79`, `setup/SKILL.md:155-161`
...
**Locations:** `done/SKILL.md:3`, `refactor/SKILL.md:3`
...
**Locations:** `setup/SKILL.md:26-27,85`, `_shared/NOTION-RESOLVER.md:11`
...
**Locations:** `_shared/NOTION-RESOLVER.md:29,33,48,70-80`, `setup/SKILL.md:85`
...
### 16. `/refactor` drops hand-offs — CONFIRMED ×2 (+2 weakened)
