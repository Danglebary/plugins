...
- [ ] Per-invocation closure loads (SKILL.md plus every unconditionally-instructed doc): refactor ≤ 7,932 words; done ≤ 6,843; retro ≤ 6,405; to-tickets ≤ 5,900 — one-third under the measured baselines.
...
- [ ] Frontmatter descriptions total ≤ ~300 words with model-invocation trigger phrases intact; setup carries `disable-model-invocation: true`; no other skill gains it.
