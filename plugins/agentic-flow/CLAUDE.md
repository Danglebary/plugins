...
- `_shared/` — reference docs shared across skills (not skills themselves): store docs (`STORE.md`, `NOTION-RESOLVER.md`), format docs (`<NAME>-FORMAT.md`), and principle docs (`<NAME>-PRINCIPLE.md`)
