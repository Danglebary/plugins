...
- `_shared/` — reference docs shared across skills (not skills themselves): store docs (`STORE.md`, `NOTION-RESOLVER.md`), format docs (`<NAME>-FORMAT.md`), principle docs (`<NAME>-PRINCIPLE.md`), and convention docs (shared procedures whose core is a plugin-shipped mechanism, e.g. `DIFF-MATERIALIZATION.md` + `scripts/materialize-diff.sh`)
