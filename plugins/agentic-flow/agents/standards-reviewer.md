...
description: Reviews a code diff for standards and smells — a twelve-smell Fowler baseline plus discovered repo standards, documented repo standards overriding the baseline, findings always labeled judgment calls, tooling-enforced rules skipped. Dispatched by /improve-codebase-architecture per the Reviewers manifest.
