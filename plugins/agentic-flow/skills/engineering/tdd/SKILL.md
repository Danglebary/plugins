...
When TDD runs inside an in-progress `agentic-flow` ticket, its stop/record behavior and its clean-completion exit tasks follow the shared [IMPLEMENTATION-LOOP.md](../../_shared/IMPLEMENTATION-LOOP.md) contract — cited here, not restated.
